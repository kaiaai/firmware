...
public:
  ...
  static constexpr char* CONFIG_YAML_ID = (char *)"config.yaml";
...
public:
  ...
  float adc_bat_voltage_full = 9.5f;
  float adc_bat_voltage_empty = 6.0f;
  uint8_t adc_bat_gpio = 36;
  uint8_t lidar_gpio_pwm = 15;
  uint8_t lidar_gpio_en = 19;
  uint8_t lidar_gpio_rx = 16;
  uint8_t lidar_gpio_tx = 17;
  float lidar_scan_freq_target = 0;
  uint8_t mot_left_enc_gpio_a_fg = 34;
  uint8_t mot_left_enc_gpio_b = 32;
  uint8_t mot_right_enc_gpio_a_fg = 35;
  uint8_t mot_right_enc_gpio_b = 26;
  uint8_t mot_right_drv_gpio_in1 = 25;
  uint8_t mot_left_drv_gpio_in1_pwm = 27;
  uint8_t mot_left_drv_gpio_in2_cw = 23;
  uint8_t mot_right_drv_gpio_in1_pwm = 25;
  uint8_t mot_right_drv_gpio_in2_cw = 13;
